...
ALTER TABLE icinga_outofsla_periods ADD constraint tp_start PRIMARY KEY (timeperiod_object_id,start_time);
ALTER TABLE icinga_outofsla_periods ADD constraint tp_end UNIQUE(timeperiod_object_id,end_time);
